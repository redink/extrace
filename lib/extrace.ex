defmodule Extrace do
  ...
  First let's trace the `:queue.new` functions in any process:
      ...
      > Extrace.calls({:queue, :new, :_}, 1)
      1
      13:14:34.086078 <0.44.0> :queue.new
      Recon tracer rate limit tripped.

  The limit was set to `1` trace message at most, and `Extrace`
  ...
  trace for each call that includes the return value:
      ...
      > Extrace.calls({:queue, :in, fn(_) -> :return end}, 3)
      1
  ...
  - `{:formatter, fn(term) -> io_data() end}`: override the default
     formatting functionality provided by Extrace.
  ...
  @doc """
  The default trace formatting functionality provided by Extrace.
